...
return [
    ...
    */
	...
	'no_user_social_logins_found' => 'No user social logins found',
	...
	'user_social_login_not_found' => 'User social login not found',
	...
	'entry_action_successfully' => 'Entry :action successfully',
	'entries_created_successfully' => 'Entries created successfully',
	'entries_updated_successfully' => 'Entries updated successfully',
	'entries_deleted_successfully' => 'Entries deleted successfully',
	'entries_action_successfully' => 'Entries :action successfully',
	'x_entries_created_successfully' => '{0}:count entry created successfully|{1}:count entry created successfully|[2,*]:count entries created successfully',
	'x_entries_updated_successfully' => '{0}:count entry updated successfully|{1}:count entry updated successfully|[2,*]:count entries updated successfully',
	'x_entries_deleted_successfully' => '{0}:count entry deleted successfully|{1}:count entry deleted successfully|[2,*]:count entries deleted successfully',
	'x_entries_action_successfully' => '{0}:count entry :action successfully|{1}:count entry :action successfully|[2,*]:count entries :action successfully',
	
	'entries_created_successfully_for' => ':Entity created successfully',
	'entries_updated_successfully_for' => ':Entity updated successfully',
	'entries_deleted_successfully_for' => ':Entity deleted successfully',
	'entries_action_successfully_for' => ':Entity :action successfully',
	'x_entries_created_successfully_for' => ':count :entity created successfully',
	'x_entries_updated_successfully_for' => ':count :entity updated successfully',
	'x_entries_deleted_successfully_for' => ':count :entity deleted successfully',
	'x_entries_action_successfully_for' => ':count :entity :action successfully',
    ...
    'are_you_sure_to_close_account' => 'Are you sure you want to close your account?',
	...
	'page_expired_reload_needed' => 'The page expired, please reload it and try again.',
    ...
    'confirm_picture_deletion' => 'Are you sure you want to delete this picture?',
	...
	'Please delete X character' => 'Please delete {charsLength} character',
	'Please enter X or more characters' => 'Please enter {minCharsLength} or more characters',
	'Loading more results' => 'Loading more results…',
	'You can only select N item' => 'You can only select {maxItems} item',
	...
	'avatar_has_been_updated' => 'Your photo or avatar have been updated.',
	'avatar_has_been_deleted' => 'Your photo or avatar has been deleted.',
...
<br>Please leave this checkbox unchecked if you do not want to renew or upgrade your package, so no payment process will be triggered.',
	...
	'archived_manually_on' => 'Manually archived on',
	'saved_on' => 'Saved on',
	'_and_' => ' and ',
	'_or_' => ' or ',
	'wizard_locked_step_message' => 'The requested step is locked. Please use the button(s) below to continue.',
	'wizard_post_input_required' => 'The listing details are required to continue.',
	'wizard_pictures_input_required' => 'The listing pictures step is required to continue.',
	'account_closure_disabled' => 'Account self-closure is disabled. Please refer to the terms of use or general conditions to submit a closure request.',
	'account_closure_unconfirmed' => 'Unconfirmed account closure. Your account will not be closed.',
	'waitingDialog_loading_title' => 'Please Wait',
	'waitingDialog_loading_text' => 'We are processing your request...',
	'waitingDialog_complete_title' => 'Completed!',
	'waitingDialog_complete_text' => 'Your task has been completed.',
	'year' => '{0}year|{1}year|[2,*]years',
	'month' => '{0}month|{1}month|[2,*]months',
	'week' => '{0}week|{1}week|[2,*]weeks',
	'day' => '{0}day|{1}day|[2,*]days',
	'hour' => '{0}hour|{1}hour|[2,*]hours',
	'minute' => '{0}minute|{1}minute|[2,*]minutes',
	'second' => '{0}second|{1}second|[2,*]seconds',
	'account_stats' => 'Account Stats',
	'entries_deleted' => 'Selected entries deleted successfully.',
	'no_entries_deleted' => 'No entries deleted.',
	'count_active_posts' => '{0} active listing|{1} active listing|[2,*] active listings',
	'count_pending_approval_posts' => '{0} pending approval listing|{1} pending approval listing|[2,*] pending approval listings',
	'count_archived_posts' => '{0} archived listing|{1} archived listing|[2,*] archived listings',
	...
	'go_home' => 'Go to Home',
	'go_back' => 'Go back',
	'pagination_meta' => 'Showing :from to :to of :total results',
